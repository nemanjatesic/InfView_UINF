...
public class AddState extends State{
	...
	public void initState() {
		...
		if (((Package)entity.getParent()).getConnection().equals(""))
			buttonAdd.addActionListener(Frame1.getInstance().getActionManager().getAddStateAction());
		else 
			buttonAdd.addActionListener(Frame1.getInstance().getActionManager().getAddDBAction());
